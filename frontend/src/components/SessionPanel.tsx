                          ...
                          <button
                            ...
                            onClick={async () => {
                              ...
                              try {
                                ...
                                await api.setSessionProxy(s.platform, ss.id, {
                                  server,
                                  username,
                                  password,
                                });
                          ...
                          {ss.proxy_host && (
                            <button
                              ...
                              onClick={async () => {
                                ...
                                setErrorNote("");
                                try {
                                  await api.clearSessionProxy(s.platform, ss.id);
                                  onChanged();
                                } catch (e) {
                                  setErrorNote((e as Error).message);
                                } finally {
              ...
              >
                {s.state !== "missing" && (
                  <button
                    ...
                    onClick={() =>
                      handleAction(
                        () => api.checkSessionNow(s.platform),
                        s.platform,
                      )
                    }
                ...
                {s.state !== "missing" && (
                  <button
                    ...
                    onClick={() =>
                      handleAction(
                        () => api.deleteSessionPool(s.platform),
                        s.platform,
                      )
                    }
                    style={{
              ...
              {isCookieOpen && (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleAction(async () => {
                        await api.saveCookies(s.platform, cookieBlob, cookieIdentifier);
                        setCookieBlob("");
                        setCookieIdentifier("");
              ...
              {s.platform === "youtube" && openYtKey && (
                ...
                >
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleAction(async () => {
                        await api.saveApiKey("youtube", ytApiKey.trim());
                        setYtApiKey("");
                        setOpenYtKey(false);
                      }, "youtube")
                    }
