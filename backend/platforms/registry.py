...
PLATFORMS: dict[str, Platform] = {
    "facebook": Platform(
        id="facebook",
        name="Facebook",
        analysis_path="backend.platforms.facebook.analysis.scraper:Scraper",
        discovery_path="backend.platforms.facebook.discovery.search:Discovery",
        session_path="backend.platforms.facebook.session:FacebookSession",
    ...
    "twitter": Platform(
        id="twitter",
        name="X / Twitter",
        analysis_path="backend.platforms.twitter.analysis:Scraper",
        discovery_path="backend.platforms.twitter.discovery:Discovery",
        session_path="backend.platforms.twitter.session:TwitterSession",
    ...
    "instagram": Platform(
        id="instagram",
        name="Instagram",
        analysis_path="backend.platforms.instagram.analysis:Scraper",
        discovery_path="backend.platforms.instagram.discovery:Discovery",
        session_path="backend.platforms.instagram.session:InstagramSession",
    ...
    "youtube": Platform(
        id="youtube",
        name="YouTube",
        analysis_path="backend.platforms.youtube.analysis:Scraper",
        discovery_path="backend.platforms.youtube.discovery:Discovery",
        api_key_env="YOUTUBE_API_KEY",
    ),
    "telegram": Platform(
        id="telegram",
        name="Telegram",
        analysis_path="backend.platforms.telegram.analysis:Scraper",
        discovery_path="backend.platforms.telegram.discovery:Discovery",
    ...
    "linkedin": Platform(
        id="linkedin",
        name="LinkedIn",
        analysis_path="backend.platforms.linkedin.analysis:Scraper",
        discovery_path="backend.platforms.linkedin.discovery:Discovery",
        session_path="backend.platforms.linkedin.session:LinkedInSession",
